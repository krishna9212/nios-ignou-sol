  ...
  return (
    <>
      <head>
        ...
        <meta property="og:description" content="Find assignments and practical files for NIOS Class 12. Filter by language and type of file." />
        <meta property="og:image" content="/images/nios-thumbnail.jpg" />
