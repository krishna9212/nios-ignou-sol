...
const SearchAssignments = () => {
  ...
  const renderCard = (assignment) => (
    <div
      key={assignment._id}
      className="bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-transform duration-300 ease-in-out p-6 flex flex-col justify-between"
    >
      <div>
        <h2 className="text-xl font-semibold text-blue-700 mb-2 hover:text-blue-900 transition duration-200">
          {assignment.name}
        </h2>
      ...
      <button
        ...
        } text-white font-semibold py-2 rounded-lg transition-all duration-300 ease-in-out shadow`}
        onClick={() =>
