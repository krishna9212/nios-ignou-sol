...
const actions = [
  {
    ...
    description: "Add a new assignment for IGNOU.",
    icon: <FaPlus size={26} />,
    route: "/admin/ignou/create",
  },
  {
    title: "Update Assignment",
    description: "Edit existing assignments for IGNOU.",
    icon: <FaEdit size={26} />,
    route: "/admin/ignou/edit",
  },
  {
    title: "Delete Assignment",
    description: "Remove assignments from the system.",
    icon: <FaTrash size={26} />,
    route: "/admin/ignou/delete",
  },
];
