...
const NIOS10AssignmentSchema = new mongoose.Schema({
  name: {
    type: String,
    required: true,
  },
...
export default mongoose.models.NIOS10Assignment || mongoose.model('NIOS10Assignment', NIOS10AssignmentSchema);
