...
const NIOS12AssignmentSchema = new mongoose.Schema({
  name: {
    type: String,
    required: true,
  },
...
export default mongoose.models.NIOS12Assignment || mongoose.model('NIOS12Assignment', NIOS12AssignmentSchema);
